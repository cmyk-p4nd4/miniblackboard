...
{
    //for MC questions
    var largestAnsDisp = document.getElementById("answerDisp"+MCQ_currentNumAns);
    if (typeof(largestAnsDisp) != 'undefined')
    {
        //remove the button 
        //the answer dialog exists, create a new one.
        
        var answerDisp = document.createElement("p");
        answerDisp.setAttribute("id","answerDisp"+(MCQ_currentNumAns+1));
        answerDisp.innerHTML = "Answer #"+(MCQ_currentNumAns+1)+": ";
        questionDiv.insertBefore(answerDisp,document.getElementById("buttons"));
...
function onRemoveAnswerBtnClicked()
{
    var largestAnsDisp = document.getElementById("answerDisp"+MCQ_currentNumAns);
    if (typeof(largestAnsDisp) != 'undefined')
        questionDiv.removeChild(largestAnsDisp);
    MCQ_currentNumAns--;
}
